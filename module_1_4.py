...
# непосредственно первоначальный вариант:

print("Курс:", course_name, ", всего задач:", number_of_task_completed,
      ", затрачено часов:",hours_spent, ", Среднее время выполнения:", time_per_task)